    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden">
            <form id="profileForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="step {{ (!isset($isEditing) || !$isEditing) ? '' : 'active' }}" data-step="1" style="{{ (!isset($isEditing) || !$isEditing) ? 'display: none;' : 'display: block;' }}">
                    <div class="bg-gradient-to-r from-yellow-500 to-orange-600 px-8 py-6">
...
<script>
    let currentStep = {{ isset($editStep) ? (int)$editStep : (isset($isEditing) && $isEditing ? 1 : 0) }};
    let totalSteps = 8;
    let selectedCities = [];
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            if (!isEditMode) {
                                ...
                                // In edit mode, reload the page to show updated completion
    ...
    $(document).ready(function() {
        ...
        // Save step button handler
        $('.save-step').on('click', function(e) {
            e.preventDefault();
            saveStep(currentStep);
        });
        
        // Previous step button (only for create mode)
        ...
        // Resume step save (only for create mode)
