...
public function showCompleteProfile(Request $request, $edit_step = null)
{
    ...
    $isEditing = $employee && ($employee->profile_step >= 8 || $edit_step !== null);
    
    // Use the route parameter if provided, otherwise use stored step or default to 1
    $editStep = $edit_step !== null ? (int)$edit_step : ($isEditing ? 1 : null);
...
private function getOrCreateEmployee()
{
    ...
    public function index()
    {
        ...
        return view('Frontend.Employee.index', compact('employee', 'completion'));
    }
